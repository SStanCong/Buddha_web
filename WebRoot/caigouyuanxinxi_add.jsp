...
function gow()
{
	document.location.href="caigouyuanxinxi_add.jsp?id=<%=id%>";
}
...
new CommDAO().insert(request,response,"caigouyuanxinxi",ext,true,false,""); 
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var caigouyuangonghaoobj = document.getElementById("caigouyuangonghao"); if(caigouyuangonghaoobj.value==""){document.getElementById("clabelcaigouyuangonghao").innerHTML="&nbsp;&nbsp;<font color=red>请输入采购员工号</font>";return false;}else{document.getElementById("clabelcaigouyuangonghao").innerHTML="  "; } 	var caigouyuangonghaoobj = document.getElementById("caigouyuangonghao");  
if(caigouyuangonghaoobj.value!=""){  
var ajax = new AJAX();
ajax.post("factory/checkno.jsp?table=caigouyuanxinxi&col=caigouyuangonghao&value="+caigouyuangonghaoobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
var msg = ajax.getValue();
if(msg.indexOf('Y')>-1){
document.getElementById("clabelcaigouyuangonghao").innerHTML="&nbsp;&nbsp;<font color=red>采购员工号已存在</font>";  
return false;
}else{document.getElementById("clabelcaigouyuangonghao").innerHTML="  ";  
}  
