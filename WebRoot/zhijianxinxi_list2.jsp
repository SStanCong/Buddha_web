...
if(request.getParameter("qicaiguige")=="" ||request.getParameter("qicaiguige")==null ){}else{sql=sql+" and qicaiguige like '%"+request.getParameter("qicaiguige")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="zhijianxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="zhijianxinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="zhijianxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
