...
function gow()
{
	document.location.href="cangkuyuanxinxi_add.jsp?id=<%=id%>";
}
...
new CommDAO().insert(request,response,"cangkuyuanxinxi",ext,true,false,""); 
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var cangkuyuangonghaoobj = document.getElementById("cangkuyuangonghao"); if(cangkuyuangonghaoobj.value==""){document.getElementById("clabelcangkuyuangonghao").innerHTML="&nbsp;&nbsp;<font color=red>请输入仓库员工号</font>";return false;}else{document.getElementById("clabelcangkuyuangonghao").innerHTML="  "; } 	var cangkuyuangonghaoobj = document.getElementById("cangkuyuangonghao");  
if(cangkuyuangonghaoobj.value!=""){  
var ajax = new AJAX();
ajax.post("factory/checkno.jsp?table=cangkuyuanxinxi&col=cangkuyuangonghao&value="+cangkuyuangonghaoobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
var msg = ajax.getValue();
if(msg.indexOf('Y')>-1){
document.getElementById("clabelcangkuyuangonghao").innerHTML="&nbsp;&nbsp;<font color=red>仓库员工号已存在</font>";  
return false;
}else{document.getElementById("clabelcangkuyuangonghao").innerHTML="  ";  
}  
