...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="186" bgcolor='#CCFFFF'>剩余容量</td>
    
    
	
    <td width="146" align="center" bgcolor="CCFFFF">添加时间</td>
    
    <td width="193" align="center" bgcolor="CCFFFF">操作</td>
  </tr>
  <% 
...
if (request.getParameter("shengyurongliang2")==""  ||request.getParameter("shengyurongliang2")==null ) {}else {sql=sql+" and shengyurongliang <= '"+request.getParameter("shengyurongliang2")+"'";}
  ...
  <tr>
    ...
    <td width="193" align="center"><a href="cangkuxinxi_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="cangkuxinxi_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="cangkuxinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> <a href="pandiandan_add.jsp?id=<%=map.get("id")%>">盘点库存</a></td>
  </tr>
  	<%
  }
   %>
