...
new CommDAO().update(request,response,"caigouyuanxinxi",ext,true,false,""); 
HashMap mmm = new CommDAO().getmaps("caigouyuangonghao",(String)request.getSession().getAttribute("username"),"caigouyuanxinxi"); 
%>
  <form  action="caigouyuanxinxi_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改采购员信息:
  <br><br>
  <%
