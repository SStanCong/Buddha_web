...
new CommDAO().update(request,response,"cangkuyuanxinxi",ext,true,false,""); 
HashMap mmm = new CommDAO().getmaps("cangkuyuangonghao",(String)request.getSession().getAttribute("username"),"cangkuyuanxinxi"); 
%>
  <form  action="cangkuyuanxinxi_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改仓库员信息:
  <br><br>
  <%
