...
if (request.getParameter("pandianriqi2")==""  ||request.getParameter("pandianriqi2")==null ) {}else {sql=sql+" and pandianriqi <= '"+request.getParameter("pandianriqi2")+"'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="pandiandan_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="pandiandan_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="pandiandan_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
