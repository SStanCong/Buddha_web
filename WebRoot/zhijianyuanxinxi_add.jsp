...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var zhijianyuangonghaoobj = document.getElementById("zhijianyuangonghao"); if(zhijianyuangonghaoobj.value==""){document.getElementById("clabelzhijianyuangonghao").innerHTML="&nbsp;&nbsp;<font color=red>请输入质检员工号</font>";return false;}else{document.getElementById("clabelzhijianyuangonghao").innerHTML="  "; } 	var zhijianyuangonghaoobj = document.getElementById("zhijianyuangonghao");  
...
if(msg.indexOf('Y')>-1){
document.getElementById("clabelzhijianyuangonghao").innerHTML="&nbsp;&nbsp;<font color=red>质检员工号已存在</font>";  
return false;
