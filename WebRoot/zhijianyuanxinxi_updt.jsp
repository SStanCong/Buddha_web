...
HashMap mmm = new CommDAO().getmap(id,"zhijianyuanxinxi"); 

%>
  <form  action="zhijianyuanxinxi_updt.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改质检员信息:
  <br><br>
