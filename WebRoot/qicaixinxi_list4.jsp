...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="105" bgcolor='#CCFFFF'>器材编号</td>
    <td width="105" bgcolor='#CCFFFF'>器材名称</td>
    <td width="105" bgcolor='#CCFFFF'>器材规格</td>
    <td width="57" bgcolor='#CCFFFF'>价格</td>
    <td width="57" bgcolor='#CCFFFF'>数量</td>
    <td width="81" bgcolor='#CCFFFF'>仓库号</td>
    <td width="92" bgcolor='#CCFFFF'>供应商名称</td>
    <td width="82" bgcolor='#CCFFFF'>生产地</td>
    
    
	
    <td width="130" align="center" bgcolor="CCFFFF">添加时间</td>
    
    <td width="105" align="center" bgcolor="CCFFFF">操作</td>
  </tr>
  <% 
...
if(request.getParameter("gongyingshangmingcheng")=="" ||request.getParameter("gongyingshangmingcheng")==null ){}else{sql=sql+" and gongyingshangmingcheng like '%"+request.getParameter("gongyingshangmingcheng")+"%'";}
  ...
  <tr>
    ...
    <td width="105" align="center"><a href="qicaixinxi_detail.jsp?id=<%=map.get("id")%>">详细</a> <a href="chukujilu_add.jsp?id=<%=map.get("id")%>">出库制造</a></td>
  </tr>
  	<%
  }
   %>
