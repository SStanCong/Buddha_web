...
<dl class="admin_login">
 <dt>
  <form name="form1" method="post" action="jspmckglxthsg3031B4?ac=adminlogin&a=a">
  <strong><font color=white>超纳理容器材厂可追源的仓库管理系统
</font></strong>
 ...
 <div style="padding-top:10px;">
  <font color=white>权限：</font><select name="cx" id="cx">
              ...
              <option value="仓库员信息">仓库员信息</option>
		<option value="采购员信息">采购员信息</option>
		<option value="质检员信息">质检员信息</option>
		<!--quxanxiaxndexnglxu-->
            </select>
	</div>	
 </dd>
