...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd class="first_dd"><a href="cangkuyuanxinxi_updt2.jsp" target="rightFrame">个人资料管理</a></dd>

		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()">仓库信息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="cangkuxinxi_add.jsp" target="rightFrame">仓库信息添加</a></dd>
			<dd><a href="cangkuxinxi_list3.jsp" target="rightFrame">仓库信息查询</a></dd>
			<dd><a href="pandiandan_list2.jsp" target="rightFrame">盘点单查询</a></dd>
		</dl>
		
	    <dl class="cloud">
			<dt onClick="changeImage()">器材信息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="cangkuxinxi_list2.jsp" target="rightFrame">器材信息添加</a></dd>
			<dd><a href="qicaixinxi_list4.jsp" target="rightFrame">器材信息查询</a></dd>
		</dl>
		
		<dl class="channel">
			<dt onClick="changeImage()">采购信息管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="jinhuo_list3.jsp" target="rightFrame">采购信息查询</a></dd>
		</dl>
	
	<dl class="channel">
			<dt onClick="changeImage()">质检信息管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="zhijianxinxi_list3.jsp" target="rightFrame">质检信息查询</a></dd>
		</dl>
