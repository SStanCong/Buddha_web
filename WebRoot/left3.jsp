...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd class="first_dd"><a href="caigouyuanxinxi_updt2.jsp" target="rightFrame">个人资料管理</a></dd>

		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()">供应商管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="gongyingshangxinxi_add.jsp" target="rightFrame">供应商信息添加</a></dd>
			<dd><a href="gongyingshangxinxi_list.jsp" target="rightFrame">供应商信息查询</a></dd>

		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()">进货管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="qicaixinxi_list2.jsp" target="rightFrame">进货添加</a></dd>
			<dd><a href="jinhuo_list2.jsp" target="rightFrame">进货查询</a></dd>

		</dl>
	
		<dl class="app">
			<dt onClick="changeImage()">订单信息管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="dingdanxinxi_list2.jsp" target="rightFrame">订单信息查询</a></dd>
		</dl>
