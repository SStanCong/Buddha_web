...
HashMap mmm = new CommDAO().getmap(id,"cangkuyuanxinxi"); 

%>
  <form  action="cangkuyuanxinxi_updt.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改仓库员信息:
  <br><br>
