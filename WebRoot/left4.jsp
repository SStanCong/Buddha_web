...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			...
			<dd class="first_dd"><a href="zhijianyuanxinxi_updt2.jsp" target="rightFrame">个人资料管理</a></dd>

		</dl>
	
		<dl class="custom">
			<dt onClick="changeImage()">质检信息管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="qicaixinxi_list3.jsp" target="rightFrame">质检信息添加</a></dd>
			<dd><a href="zhijianxinxi_list2.jsp" target="rightFrame">质检信息查询</a></dd>
