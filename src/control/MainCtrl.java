	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if (utype.equals("仓库员信息")){sql1="select * from cangkuyuanxinxi where cangkuyuangonghao='"+username+"' and mima='"+password+"'";}		if (utype.equals("采购员信息")){sql1="select * from caigouyuanxinxi where caigouyuangonghao='"+username+"' and mima='"+password+"'";}		if (utype.equals("质检员信息")){sql1="select * from zhijianyuanxinxi where zhijianyuangonghao='"+username+"' and mima='"+password+"'";}		//quxanxiaxndexnglxu
